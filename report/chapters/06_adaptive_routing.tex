...
Routing applies decisions in strict priority order (Figure~\ref{fig:routing_flow}):
\begin{enumerate}
...
\begin{figure}[H]
  ...
  \resizebox{0.95\textwidth}{!}{%
    \input{figures/routing_flow.tex}%
  }
  \caption{Adaptive routing decision flow: force method, config override, metric rules, then OM-LSA fallback.}
